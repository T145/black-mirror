...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td id="BLOCK-DOMAIN-line-count">8,969,100</td>
    ...
    <tr>
      ...
      <td id="BLOCK-IPV4-line-count">1,211,734</td>
    ...
    <tr>
      ...
      <td id="BLOCK-CIDR4-line-count">8,871</td>
    ...
    <tr>
      <td>ALLOW_DOMAIN</td>
      <td>Punycode domains</td>
      <td id="ALLOW-DOMAIN-line-count">932,404</td>
    ...
    <tr>
      <td>ALLOW_IPV4</td>
      <td>IPv4 addresses</td>
      <td id="ALLOW-IPV4-line-count">78,946</td>
    ...
    <tr>
      <td>ALLOW_IPV6</td>
      <td>IPv6 addresses</td>
      <td id="ALLOW-IPV6-line-count">3,187</td>
    ...
    <tr>
      <td>ALLOW_CIDR4</td>
      <td>IPv4 CIDR blocks</td>
      <td id="ALLOW-CIDR4-line-count">3,310</td>
      <td id="ALLOW-CIDR4-file-size">51K</td>
      <td align="center"><a href="https://github.com/T145/black-mirror/releases/download/latest/ALLOW_CIDR4.txt">🔗</a></td>
    </tr>
    <tr>
      <td>ALLOW_CIDR6</td>
      <td>IPv6 CIDR blocks</td>
      <td id="ALLOW-CIDR6-line-count">155,990</td>
