...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td id="BLOCK-DOMAIN-line-count">8,411,784</td>
    ...
    <tr>
      ...
      <td id="BLOCK-IPV4-line-count">787,641</td>
    ...
    <tr>
      ...
      <td id="BLOCK-IPV6-line-count">1,302</td>
    ...
    <tr>
      ...
      <td id="BLOCK-CIDR4-line-count">9,924</td>
    ...
    <tr>
      <td>ALLOW_DOMAIN</td>
      <td>Punycode domains</td>
      <td id="ALLOW-DOMAIN-line-count">674,384</td>
    ...
    <tr>
      <td>ALLOW_IPV4</td>
      <td>IPv4 addresses</td>
      <td id="ALLOW-IPV4-line-count">74,950</td>
    ...
    <tr>
      <td>ALLOW_IPV6</td>
      <td>IPv6 addresses</td>
      <td id="ALLOW-IPV6-line-count">2,833</td>
    ...
    <tr>
      <td>ALLOW_CIDR4</td>
      <td>IPv4 CIDR blocks</td>
      <td id="ALLOW-CIDR4-line-count">13,891</td>
      <td id="ALLOW-CIDR4-file-size">213K</td>
      <td align="center"><a href="https://github.com/T145/black-mirror/releases/download/latest/ALLOW_CIDR4.txt">🔗</a></td>
    </tr>
    <tr>
      <td>ALLOW_CIDR6</td>
      <td>IPv6 CIDR blocks</td>
      <td id="ALLOW-CIDR6-line-count">147,402</td>
