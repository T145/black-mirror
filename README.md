...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td id="BLOCK-DOMAIN-line-count">8,404,782</td>
    ...
    <tr>
      ...
      <td id="BLOCK-IPV4-line-count">1,089,399</td>
    ...
    <tr>
      ...
      <td id="BLOCK-IPV6-line-count">1,007</td>
    ...
    <tr>
      ...
      <td id="BLOCK-CIDR4-line-count">8,078</td>
    ...
    <tr>
      ...
      <td id="BLOCK-CIDR6-line-count">150</td>
    ...
    <tr>
      <td>ALLOW_DOMAIN</td>
      <td>Punycode domains</td>
      <td id="ALLOW-DOMAIN-line-count">932,355</td>
    ...
    <tr>
      <td>ALLOW_IPV4</td>
      <td>IPv4 addresses</td>
      <td id="ALLOW-IPV4-line-count">77,876</td>
    ...
    <tr>
      <td>ALLOW_IPV6</td>
      <td>IPv6 addresses</td>
      <td id="ALLOW-IPV6-line-count">2,998</td>
      <td id="ALLOW-IPV6-file-size">114K</td>
      <td align="center"><a href="https://github.com/T145/black-mirror/releases/download/latest/ALLOW_IPV6.txt">🔗</a></td>
    </tr>
    <tr>
      <td>ALLOW_CIDR4</td>
      <td>IPv4 CIDR blocks</td>
      <td id="ALLOW-CIDR4-line-count">7,611</td>
    ...
    <tr>
      <td>ALLOW_CIDR6</td>
      <td>IPv6 CIDR blocks</td>
      <td id="ALLOW-CIDR6-line-count">156,344</td>
