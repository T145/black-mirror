...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td id="black-domain-line-count">7,360,031</td>
      <td id="black-domain-file-size">165M</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-line-count">709,171</td>
      <td id="black-ipv4-file-size">9.6M</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-cidr-line-count">29,223</td>
      <td id="black-ipv4-cidr-file-size">489K</td>
    ...
    <tr>
      ...
      <td id="black-ipv6-line-count">10,253</td>
      <td id="black-ipv6-file-size">316K</td>
    ...
    <tr>
      <td>white_domain</td>
      <td>Domain entries</td>
      <td id="white-domain-line-count">22,064</td>
      <td id="white-domain-file-size">336K</td>
    ...
    <tr>
      <td>white_ipv4</td>
      <td>IPv4 addresses</td>
      <td id="white-ipv4-line-count">12,072</td>
      <td id="white-ipv4-file-size">167K</td>
    ...
    <tr>
      ...
      <td>IPv4 CIDR blocks</td>
      <td id="white-ipv4-cidr-line-count">1,550</td>
      <td id="white-ipv4-cidr-file-size">25K</td>
    ...
    <tr>
      <td>white_ipv6</td>
      <td>IPv6 addresses</td>
      <td id="white-ipv6-line-count">2,750</td>
      <td id="white-ipv6-file-size">105K</td>
