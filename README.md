...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td id="black-domain-line-count">7,563,225</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-line-count">670,062</td>
      <td id="black-ipv4-file-size">9.1M</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-cidr-line-count">42,540</td>
      <td id="black-ipv4-cidr-file-size">714K</td>
    ...
    <tr>
      ...
      <td id="black-ipv6-line-count">10,577</td>
      <td id="black-ipv6-file-size">325K</td>
    ...
    <tr>
      <td>white_domain</td>
      <td>Domain entries</td>
      <td id="white-domain-line-count">416,548</td>
    ...
    <tr>
      <td>white_ipv4</td>
      <td>IPv4 addresses</td>
      <td id="white-ipv4-line-count">17,799</td>
      <td id="white-ipv4-file-size">239K</td>
    ...
    <tr>
      ...
      <td>IPv4 CIDR blocks</td>
      <td id="white-ipv4-cidr-line-count">1,375</td>
      <td id="white-ipv4-cidr-file-size">22K</td>
    ...
    <tr>
      <td>white_ipv6</td>
      <td>IPv6 addresses</td>
      <td id="white-ipv6-line-count">2,792</td>
