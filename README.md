...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td id="black-domain-line-count">7,601,384</td>
      <td id="black-domain-file-size">178M</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-line-count">718,834</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-cidr-line-count">60,809</td>
      <td id="black-ipv4-cidr-file-size">1020K</td>
    ...
    <tr>
      ...
      <td id="black-ipv6-line-count">10,338</td>
      <td id="black-ipv6-file-size">319K</td>
    ...
    <tr>
      <td>white_domain</td>
      <td>Domain entries</td>
      <td id="white-domain-line-count">416,612</td>
    ...
    <tr>
      <td>white_ipv4</td>
      <td>IPv4 addresses</td>
      <td id="white-ipv4-line-count">24,995</td>
      <td id="white-ipv4-file-size">335K</td>
    ...
    <tr>
      ...
      <td>IPv4 CIDR blocks</td>
      <td id="white-ipv4-cidr-line-count">1,258</td>
      <td id="white-ipv4-cidr-file-size">20K</td>
    ...
    <tr>
      <td>white_ipv6</td>
      <td>IPv6 addresses</td>
      <td id="white-ipv6-line-count">2,684</td>
      <td id="white-ipv6-file-size">102K</td>
