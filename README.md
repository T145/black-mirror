...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td id="black-domain-line-count">7,397,858</td>
      <td id="black-domain-file-size">171M</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-line-count">699,090</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-cidr-line-count">37,034</td>
      <td id="black-ipv4-cidr-file-size">621K</td>
    ...
    <tr>
      ...
      <td id="black-ipv6-line-count">10,126</td>
      <td id="black-ipv6-file-size">313K</td>
    ...
    <tr>
      <td>white_domain</td>
      <td>Domain entries</td>
      <td id="white-domain-line-count">416,456</td>
    ...
    <tr>
      <td>white_ipv4</td>
      <td>IPv4 addresses</td>
      <td id="white-ipv4-line-count">11,878</td>
      <td id="white-ipv4-file-size">164K</td>
    ...
    <tr>
      ...
      <td>IPv4 CIDR blocks</td>
      <td id="white-ipv4-cidr-line-count">1,571</td>
    ...
    <tr>
      <td>white_ipv6</td>
      <td>IPv6 addresses</td>
      <td id="white-ipv6-line-count">2,770</td>
