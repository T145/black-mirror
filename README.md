...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td id="BLOCK-DOMAIN-line-count">9,198,270</td>
      <td id="BLOCK-DOMAIN-file-size">197M</td>
    ...
    <tr>
      ...
      <td id="BLOCK-IPV4-line-count">1,082,734</td>
    ...
    <tr>
      ...
      <td id="BLOCK-IPV6-line-count">1,338</td>
      <td id="BLOCK-IPV6-file-size">44K</td>
    ...
    <tr>
      ...
      <td id="BLOCK-CIDR4-line-count">8,570</td>
      <td id="BLOCK-CIDR4-file-size">141K</td>
    ...
    <tr>
      <td>ALLOW_IPV4</td>
      <td>IPv4 addresses</td>
      <td id="ALLOW-IPV4-line-count">72,862</td>
      <td id="ALLOW-IPV4-file-size">996K</td>
    ...
    <tr>
      <td>ALLOW_CIDR4</td>
      <td>IPv4 CIDR blocks</td>
      <td id="ALLOW-CIDR4-line-count">7,972</td>
      <td id="ALLOW-CIDR4-file-size">123K</td>
      <td align="center"><a href="https://github.com/T145/black-mirror/releases/download/latest/ALLOW_CIDR4.txt">🔗</a></td>
    </tr>
    <tr>
      <td>ALLOW_CIDR6</td>
      <td>IPv6 CIDR blocks</td>
      <td id="ALLOW-CIDR6-line-count">156,935</td>
