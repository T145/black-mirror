...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td id="black-domain-count">8,095,558</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-count">789,096</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-cidr-count">10,028</td>
      <td id="black-ipv4-cidr-filesize">166K</td>
    ...
    <tr>
      <td>white_domain</td>
      <td>Domain entries</td>
      <td id="white-domain-count">46,022</td>
      <td id="white-domain-filesize">781K</td>
    ...
    <tr>
      <td>white_ipv4</td>
      <td>IPv4 addresses</td>
      <td id="white-ipv4-count">11,738</td>
    ...
    <tr>
      ...
      <td>IPv4 CIDR blocks</td>
      <td id="white-ipv4-cidr-count">1,430</td>
    ...
    <tr>
      <td>white_ipv6</td>
      <td>IPv6 addresses</td>
      <td id="white-ipv6-count">2,364</td>
