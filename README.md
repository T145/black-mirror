...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td id="black-domain-count">8,060,484</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-count">791,489</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-cidr-count">33,205</td>
      <td id="black-ipv4-cidr-filesize">554K</td>
    ...
    <tr>
      ...
      <td id="black-ipv6-count">8,311</td>
    ...
    <tr>
      <td>white_domain</td>
      <td>Domain entries</td>
      <td id="white-domain-count">45,942</td>
      <td id="white-domain-filesize">780K</td>
    ...
    <tr>
      <td>white_ipv4</td>
      <td>IPv4 addresses</td>
      <td id="white-ipv4-count">11,648</td>
    ...
    <tr>
      ...
      <td>IPv4 CIDR blocks</td>
      <td id="white-ipv4-cidr-count">1,382</td>
    ...
    <tr>
      <td>white_ipv6</td>
      <td>IPv6 addresses</td>
      <td id="white-ipv6-count">2,331</td>
