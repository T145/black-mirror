...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td id="black-domain-count">7,731,007</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-count">784,504</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-cidr-count">12,604</td>
      <td id="black-ipv4-cidr-filesize">209K</td>
    ...
    <tr>
      ...
      <td id="black-ipv6-count">8,293</td>
    ...
    <tr>
      <td>white_domain</td>
      <td>Domain entries</td>
      <td id="white-domain-count">46,771</td>
    ...
    <tr>
      <td>white_ipv4</td>
      <td>IPv4 addresses</td>
      <td id="white-ipv4-count">11,868</td>
    ...
    <tr>
      ...
      <td>IPv4 CIDR blocks</td>
      <td id="white-ipv4-cidr-count">1,449</td>
    ...
    <tr>
      <td>white_ipv6</td>
      <td>IPv6 addresses</td>
      <td id="white-ipv6-count">2,583</td>
