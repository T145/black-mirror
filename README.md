...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td id="black-domain-count">9,169,648</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-count">897,996</td>
    ...
    <tr>
      ...
      <td id="black-ipv4-cidr-count">30,791</td>
      <td id="black-ipv4-cidr-filesize">514K</td>
    ...
    <tr>
      ...
      <td id="black-ipv6-count">8,062</td>
    ...
    <tr>
      <td>white_domain</td>
      <td>Domain entries</td>
      <td id="white-domain-count">45,368</td>
    ...
    <tr>
      ...
      <td>IPv4 CIDR blocks</td>
      <td id="white-ipv4-cidr-count">1,362</td>
    ...
    <tr>
      <td>white_ipv6</td>
      <td>IPv6 addresses</td>
      <td id="white-ipv6-count">2,474</td>
