...
RUN apt-get -y install aria2 build-essential curl gawk git golang-go gpg grepcidr gzip idn2 jq libdata-validate-domain-perl libdata-validate-ip-perl libnet-idn-encode-perl libnet-libidn-perl libregexp-common-perl libtry-tiny-perl lynx miller moreutils nano p7zip-full preload python3-pip sed \
&& apt-get clean \
